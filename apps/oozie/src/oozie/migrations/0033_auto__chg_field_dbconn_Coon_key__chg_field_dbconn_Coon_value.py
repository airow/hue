...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DBConn.Coon_key'
        db.alter_column(u'oozie_dbconn', 'Coon_key', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'DBConn.Coon_value'
        db.alter_column(u'oozie_dbconn', 'Coon_value', self.gf('django.db.models.fields.CharField')(max_length=180))

    def backwards(self, orm):

        # Changing field 'DBConn.Coon_key'
        db.alter_column(u'oozie_dbconn', 'Coon_key', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'DBConn.Coon_value'
        db.alter_column(u'oozie_dbconn', 'Coon_value', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        u'oozie.bundle': {
            ...
            'kick_off_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 4, 11, 0, 0)'})
        },
        ...
        u'oozie.coordinator': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 4, 14, 0, 0)'}),
            ...
            u'job_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['oozie.Job']", 'unique': 'True', 'primary_key': 'True'}),
            'start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 4, 11, 0, 0)'}),
        ...
        u'oozie.dbconn': {
            'Coon_key': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'Coon_type': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'Coon_value': ('django.db.models.fields.CharField', [], {'max_length': '180'}),
            'Meta': {'object_name': 'DBConn'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'oozie.decision': {
