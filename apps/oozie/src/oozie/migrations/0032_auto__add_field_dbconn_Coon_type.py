...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DBConn.Coon_type'
        db.add_column(u'oozie_dbconn', 'Coon_type',
                      self.gf('django.db.models.fields.CharField')(default='SQLServer', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DBConn.Coon_type'
        db.delete_column(u'oozie_dbconn', 'Coon_type')
    ...
    models = {
        ...
        u'oozie.bundle': {
            ...
            'kick_off_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2018, 12, 28, 0, 0)'})
        },
        ...
        u'oozie.coordinator': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2018, 12, 31, 0, 0)'}),
            ...
            u'job_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['oozie.Job']", 'unique': 'True', 'primary_key': 'True'}),
            'start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2018, 12, 28, 0, 0)'}),
        ...
        u'oozie.dbconn': {
            'Coon_key': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'Coon_type': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'Coon_value': ('django.db.models.fields.TextField', [], {}),
