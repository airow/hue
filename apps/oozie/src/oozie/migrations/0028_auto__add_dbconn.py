...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DBConn'
        db.create_table(u'oozie_dbconn', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('Coon_key', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('Coon_value', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'oozie', ['DBConn'])


    def backwards(self, orm):
        # Deleting model 'DBConn'
        db.delete_table(u'oozie_dbconn')
    ...
    models = {
        ...
        u'oozie.bundle': {
            ...
            'kick_off_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2018, 3, 27, 0, 0)'})
        },
        ...
        u'oozie.coordinator': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2018, 3, 30, 0, 0)'}),
            ...
            u'job_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['oozie.Job']", 'unique': 'True', 'primary_key': 'True'}),
            'start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2018, 3, 27, 0, 0)'}),
        ...
        u'oozie.dbconn': {
            ...
            'Coon_value': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
