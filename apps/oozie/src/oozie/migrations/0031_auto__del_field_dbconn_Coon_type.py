...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'oozie.bundle': {
            ...
            'kick_off_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2018, 12, 27, 0, 0)'})
        },
        ...
        u'oozie.coordinator': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2018, 12, 30, 0, 0)'}),
            ...
            u'job_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['oozie.Job']", 'unique': 'True', 'primary_key': 'True'}),
            'start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2018, 12, 27, 0, 0)'}),
