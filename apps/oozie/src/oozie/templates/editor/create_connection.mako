...
${ commonheader(_("Create Connection"), "oozie", user, request) | n,unicode }
    ...
    <div class="span2">
      <div id="connectionControls" class="sidebar-nav">
        <ul class="nav nav-list">
          <li class="nav-header">${ _('New connection') }</li>
    ...
    <div class="span10">
      <div class="card card-small">
        <div class="alert alert-info"><h3>${ _('Properties') }</h3></div>
          <div class="card-body">
            <p>
              <form class="form-horizontal" id="connectionForm" action="${ url('oozie:create_connection') }" method="POST">
