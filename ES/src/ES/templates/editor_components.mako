...
<br></br>
## font-weight:bold;
<h2 align="center" style="font-style:italic;"> 创建索引 </h2> 
<div style="text-align: center">
<span align="center" class="widget-label" onclick="openTemplateManager()">
<a href="javascript:void(0)">
<i align="center"  class="fa fa-fw fa-send"></i> (单击进入模板管理）
</a>
</span>
</div>
  ...
  <div class="airy" style="text-align: center">
    <table width="100%" border="0" align="right">
      ...
      <table width="100%" border="0" align="right">
        ...
        <td align="left" width="58%">
        <input type="text" id="idxname" class="inputIdxName" validate="nonempty" placeholder="Index Name.">
        </td>
        </tr>
        </table>
      </div>
      ...
      <table width="100%" border="0" align="right">
        ...
        <td align="left" width="58%">
        <input type="text" id="shardsnum" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"
 class="inputShardsNum" validate="nonempty" placeholder="Number of Shards.">
      ...
      <table width="100%" border="0" align="right">
        ...
        <td align="left" width="58%">
        <input type="text" id="replicasnum" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" class="inputShardsNum" validate="nonempty" placeholder="Number of Replicas.">
        </td>
        </tr>
        </table>
      </div>
...
<div style="text-align:center">
<input align="center" type="button" name="Create" value="创建" onclick="uploadJson()" />
<br>
...
##             document.getElementById(typedropdownlist).addEventListener('change',function(){
##                  obj
##                  },false);
##              }
## </script>
...
function openTemplateManager(){
  ...
  debugger;
  var self = this;
  ## var name=self.definition.name;
  ## alert("indexname: "+name);
  ## var cluster=$(".assist-breadcrumb-text[title]").html();
  ## var s=Math.random()*10;
  var url="/ES/views/addTemplates";
...
newRow.cells[1].innerHTML='fieldname';
newRow.cells[2].innerHTML='';
newRow.cells[3].innerHTML='';
## alert(newRow.cells[0]);
