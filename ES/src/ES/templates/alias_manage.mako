  ...
  <div data-bind="visibleOnHover: { override: inFocus() || settingsVisible() || dbSelectionVisible() || $root.editorMode() || saveResultsModalVisible(), selector: '.hover-actions' }">
    ...
    <br></br>  
      <div class="airy" style="text-align: center">
        ...
        <input type="text" disabled="true" id="idxname" class="input-xlarge" validate="nonempty" >
      </div>
## <div>
<div class="airy" style="text-align: center">
            <br>

          <a href="#" onclick="AddAliasInput()">
...
<div style="text-align:center">
<input align="center" type="button" name="Create" value="修改别名" onclick="uploadAddFields()" />
</div>
<br></br>
</div>
</script>
...
## ## if(arrayType[i]=="_default_") continue;
## ##  url[j]=""
...
## ##   alert(indexJson);
## ##   debugger;
## ## var url="/ES/views/editAlias/"

##     $.post("/ES/views/editAlias/", {
