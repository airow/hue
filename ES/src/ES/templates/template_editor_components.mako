...
<br></br>
## font-weight:bold;
<h2 align="center" style="font-style:italic;"> 创建模板 </h2> 
  ...
  <div class="airy" style="text-align: center">
    <table width="100%" border="0" align="right">
          ...
          <span class="widget-label" >集群名: </span>
          </td>
          <td align="left" width="58%">
          <select id="cluster"><option value="http://hdpjntest.chinacloudapp.cn:12200/">ESLog</option><option value="http://hdpjntest.chinacloudapp.cn:12200/">ESBiz</option></select>
          </td>
          </tr>
    </table>
  </div>
  ...
  <div class="airy" style="text-align: center">
    <table width="100%" border="0" align="right">
          <tr>
          <td align="right" width="42%">
          <span class="widget-label" >分区策略: </span>
          </td>
          <td align="left" width="58%">
          <select id="partitionGranularity"><option value="0">不分区</option><option value="1">周</option><option value="2">月</option><option value="3">季</option><option value="4">年</option><option value="5">天</option></select>
          </td>
          </tr>
    </table>
  </div>        
      ...
      <table width="100%" border="0" align="right">
        <tr>
        <td align="right" width="42%">
        <span class="widget-label" >模板名: </span>
        </td>
        <td align="left" width="58%">
        <input type="text" id="idxname" class="inputIdxName" validate="nonempty" placeholder="Template Name.">
        </td>
        </tr>
        </table>
      </div>
      ...
      <table width="100%" border="0" align="right">
        <tr>
        <td align="right" width="42%">
        <span class="widget-label" >分片数:</span>
        </td>
        <td align="left" width="58%">
        <input type="text" id="shardsnum" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" class="inputShardsNum" validate="nonempty" placeholder="Number of Shards.">
        </td>
        </tr>
        </table>
      </div>
      ...
      <table width="100%" border="0" align="right">
        <tr>
        <td align="right" width="42%">
        <span class="widget-label" >副本数:</span>
        </td>
        <td align="left" width="58%">
        <input type="text" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" id="replicasnum" class="inputShardsNum" validate="nonempty" placeholder="Number of Replicas.">
        </td>
        </tr>
        </table>
      </div>
      ...
      <table width="100%" border="0" align="right">
        <tr>
        <td align="right" width="42%">
        <span class="widget-label" >最大返回条数:</span>
        </td>
        <td align="left" width="58%">
        <input type="text" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" id="maxresultwindow" validate="nonempty" placeholder="Number of Results.">
        </td>
        </tr>
        </table>
      </div>
      ...
      <div class="airy" id="alias" style="text-align: center">
      <table width="100%" border="0" align="right">
            <tr>
            <td align="right" width="42%">
            <span id="spanAlias1" class="widget-label" >别名1: </span>
            </td>
            <td align="left" width="58%">
              <input width="80" id="Alias1" type="text" class="inputalias" validate="nonempty" placeholder="Alias.">
              ## <a href="#" onclick="DecInput()">
              ##   <i class="fa fa-minus" id="Alias1"></i>
              ## </a>
            </td>
            </tr>
      </table>
        ...
        <div class="airy" style="text-align: center">
          ...
          ## <a class="pointer" data-bind="click: function(){ this.push(ko.mapping.fromJS({'name': '', 'value': ''})); }">

        &nbsp;
          <a href="#" onclick="DecInput()">
            <i class="fa fa-minus"></i>${ _('Remove Alias') }
          </a>
        <br />
        </div>
...
<input align="center" type="button" name="Submit3" value="模板JSON" onclick="TemplateJSON(document.getElementById('tabProduct'))" />    
## <input align="center" type="button" name="Submit3" value="模板JSON" onclick="TemplateJSON(document.getElementById('tabProduct'))" />    
</form> 
</div>
<br></br>
...
<div style="text-align:center">
<input align="center" type="button" name="Create" value="创建" onclick="uploadTemplateJson()" />
...
var maxresultwindow=document.getElementById("maxresultwindow").value;
...
## debugger;
var url="/ES/views/getJson/";

    $.post("/ES/views/getJson/", {
        indexJson: ko.mapping.toJSON(indexJson),
