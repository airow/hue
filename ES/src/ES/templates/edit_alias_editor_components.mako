...
<script type="text/html" id="snippet${ suffix }">
  <div data-bind="visibleOnHover: { override: inFocus() || settingsVisible() || dbSelectionVisible() || $root.editorMode() || saveResultsModalVisible(), selector: '.hover-actions' }">
    ...
    <div class="airy" style="text-align: center">
          ...
          <select id="cluster" style="display:none"><option value="http://hdpjntest.chinacloudapp.cn:12200/">ESLog</option><option value="http://hdpjntest.chinacloudapp.cn:12200/">ESBiz</option></select>
        </div>
##         <script>
## alert(indexAlias)
## </script>
    
<h2 align="center" style="font-style:italic;"> 修改别名 </h2>
<div class="airy" style="text-align: center">
...
<input align="center" type="button" name="Create" value="更新别名" onclick="ModifyAlias()" />
</div>
<br></br>
</div>
</script>
