...
<%namespace name="assist" file="/template_assist.mako" />
<%namespace name="configKoComponents" file="/config_ko_components.mako" />
<%namespace name="editorComponents" file="template_editor_components.mako" />
...
<span id="editorComponents" class="editorComponents notebook">asdf
