  ...
  <div class="airy" style="text-align: center">
    <table width="100%" border="0" align="right">
      ...
      <table width="100%" border="0" align="right">
        ...
        <td align="left" width="58%">
        <input type="text" id="shardsnum" class="inputShardsNum" validate="nonempty" placeholder="Number of Shards.">
        </td>
        </tr>
        </table>
      </div>
      ...
      <table width="100%" border="0" align="right">
        ...
        <td align="left" width="58%">
        <input type="text" id="replicasnum" class="inputShardsNum" validate="nonempty" placeholder="Number of Replicas.">
        </td>
        </tr>
        </table>
      </div>
      ...
      <table width="100%" border="0" align="right">
        ...
        <td align="left" width="58%">
        <input type="text" id="maxresultwindow" validate="nonempty" placeholder="Number of Results.">
        </td>
        </tr>
        </table>
      </div>
