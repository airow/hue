...
<br></br>
<h2 align="center" class="card-heading simple"> 添加字段 </h2>
  <div data-bind="visibleOnHover: { override: inFocus() || settingsVisible() || dbSelectionVisible() || $root.editorMode() || saveResultsModalVisible(), selector: '.hover-actions' }">
    ...
    <br></br>
      ...
      <div class="airy" style="text-align: center">
        ...
        <input type="text" disabled="true" value="${name}" id="idxname" class="input-xlarge" validate="nonempty" >
      </div>
    <div>
...
<table class="table datatables" align="center" width="900" border="0" cellpadding="0" cellspacing="0" id="tabProduct">    
    <tr>   
      ...
      <th rowspan="1" colspan="1" style="width: 294px;" Name="DataType" EditType="DropDownList" DataItems="{text:'text:模糊匹配，全文搜索',value:'text'},{text:'keyword:全词匹配，可排序，可聚合',value:'keyword'},{text:'以上两项',value:'two'},{text:'Integer',value:'integer'},{text:'Long',value:'long'},{text:'Short',value:'short'},{text:'Double',value:'double'},{text:'Float',value:'float'},{text:'Boolean',value:'boolean'},{text:'Date',value:'date'},{text:'Range',value:'range'}">数据类型</th>
      <th rowspan="1" colspan="1" style="width: 343px;" Name="Format">格式</th> 
      ## <td width="32" align="center" bgcolor="#EFEFEF" Name="Checked"><input style="display:none" type="checkbox" name="checkbox" value="checkbox" /></td>    
...
<input align="center" type="button" name="Submit3" class="btn" value="索引JSON" onclick="IndexJSON(document.getElementById('tabProduct'))" />    
</form> 
</div>
<br></br>
...
<div style="text-align:center">
<input align="center" type="button" name="Create" class="btn" value="添加字段" onclick="uploadAddFields()" />
</div>
<br></br>
</div>
</script>
...
## var localName="${name}";
## alert(localName);
## ## idxname=document.getElementById("idxname");
...
function uploadAddFields(){
  ...
  var url0="${myurl}";
  var mycluster="${clustername}"
  var myindJson00=document.getElementById("textarea1").value;
  ## alert("~~~~~~~~~~~~~~~~~~~~~~~~~~url0:"+url0.toString());
  ## alert(indexJson);
  debugger;
...
if((strusergroup=teldUserName["responseJSON"]["WorkGroupName"])==undefined){
  ...
  strusergroup=teldUserName["responseJSON"]["WorkGroupName"];
    ...
    $.post("/Index/views/getJsonAddFields/", {
        indexName:ko.mapping.toJSON(localIdxName),
        addFieldJson:myindJson00,
        ...
        mycluster:ko.mapping.toJSON(mycluster)
      }, function(msg) {
        ## alert(msg);
        ...
        else if(objmsg["error"]["root_cause"][0]["type"]=="index_not_found_exception"){alert("索引不存在 更新失败!")}
        else{alert("更新失败!")}
...
myindJson={"properties":properties}

textarea0.value="";
textarea0.value=JSON.stringify(myindJson);
textarea0.innerText=JSON.stringify(myindJson);
textarea0.innerHTML=JSON.stringify(myindJson);
