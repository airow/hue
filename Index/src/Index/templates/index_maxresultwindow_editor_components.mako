...
<%def name="commonHTML(indName=[],indexmaxresultwindow=[], is_embeddable=False, suffix='')">
...
<h2 align="center" class="card-heading simple"> 修改最大返回条数 </h2>
<br></br>
<div class="airy" style="text-align: center">
...
<%
numMxRsltWin=indexmaxresultwindow;
...
%>
  ...
  <div class="airy" style="text-align: center" id="alias">
    <table width="100%" border="0" align="right" id="tablealias">
          %if numMxRsltWin!="":
          <tr id="trMxRsltWin">
          <td align="right" width="42%" id="td1MxRsltWin">
          <span class="widget-label" id="spanMxRsltWin">最大返回条数: </span>
          </td>
          <td align="left" width="58%" id="td2MxRsltWin">
          <input id="inputMxRsltWin" class="inputalias" value="${numMxRsltWin}" type="text" validate="nonempty" >
          </td>
          </tr>
          %endif
          %if numMxRsltWin=="":
          ...
          <td align="left" width="58%" id="td2MxRsltWin">
          <input id="inputMxRsltWin" class="inputalias" value="" type="text" validate="nonempty" >
          &nbsp;
          </td>
          </tr>
          %endif          
...
<input align="center" type="button" class="btn" name="Create" value="更新" onclick="ModifyMxRsltWin()" />
</div>
<br></br>
</div>
</script>
...
function ModifyMxRsltWin(){
## user name of teld system

MxRsltWinnumber=document.getElementById('inputMxRsltWin').value;

if(MxRsltWinnumber>500000){
  alert("Max Result Window should be no more than 500000");
  return;
}
jsonstring={"index":{"max_result_window":MxRsltWinnumber}};
...
## user name and user group of teld system
...
$.post("/Index/views/modifyMxRsltWin/", {
        indexName:ko.mapping.toJSON(tempindname),
        MxRsltWinnum:ko.mapping.toJSON(MxRsltWinnumber),
        jsonstr:ko.mapping.toJSON(jsonstring),
        url:ko.mapping.toJSON(url0),
        mycluster:ko.mapping.toJSON(clustername),
        ...
        if(objmsg["acknowledged"]==true){alert("'"+tempindname+"' Max Result Window更新成功!");
        location.reload(true);
        }
        else if(objmsg["error"]["root_cause"][0]["type"]=="index_not_found_exception"){alert(tempindname+" 索引不存在 Max Result Window更新失败!")}
        else{alert(tempindname+" Max Result Window更新失败!")}
      });
