...
<%namespace name="editorComponents" file="index_alias_editor_components.mako" />
...
${ editorComponents.commonHTML(indName=indName,indexAlias=indAliases, is_embeddable=is_embeddable, suffix='editor') }
