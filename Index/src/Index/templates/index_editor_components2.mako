        ...
        <ul class="nav editor-nav">
          <li class="app-header">
            <!-- ko if: editorMode -->
              ...
              ## <a data-bind="click:function() {location.href="/Index/editAlias"}" style="cursor: pointer">
...
## <h2 align="center" class="card-heading simple"> 创建索引 </h2> 
...
## <div class="row">
## <div class="col-lg-12 col-sm-12 col-xs-12">
## <form id="SingleCardForm" method="post" role="form" class="form-horizontal">
## <div class="row">
## <div class="col-lg-12 col-sm-12 col-xs-12">
## <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">

## <div class="row">
## <div style="width: 100px;background-color: #ddffff!important;padding: 14px;border-left: 6px solid #ccc!important;border-color: #2196F3!important;">

<div class="well widget-body">
<div style="width: 100px;padding: 14px;border-left: 6px solid #ccc!important;border-color: #4682BF!important;border-bottom: 1px solid #ccc!important;border-color: #4682BF!important;border-top: 1px solid #ccc!important;border-color: #4682BF!important;border-right: 1px solid #ccc!important;border-color: #4682BF!important;">
## <h5 class="row-title before-color" style="margin-left:-12px;">
 <i class="fa fa-file-text iconcolor"></i>
 基本信息
##  </h5>
</div>   
<div class="form-group">
## <table frame="void" align="center" width="900" border="0" cellpadding="0" cellspacing="0" id="tabProduct0">    
    ## <tr>
      ...
      <label class="col-sm-4 control-label">集群名</label>
      <div class="col-sm-8">
      <input type="text" id="idxname" name="idxname" maxlength="36" data-bv-notempty="true" data-bv-notempty-message="请输入" class="form-control" data-bv-field="idxname">
      <div class="errbox" role="errbox" id="Initial_ErrBox" style="display: none;"><div class="arrow"></div>
      <div class="errbox-content"><pre data-bv-validator="notEmpty" data-bv-validator-for="Initial" class="help-block" style="display: none;">请输入车系首字母(最大范围是1个字符)</pre>
      <pre data-bv-validator="regexp" data-bv-validator-for="Initial" class="help-block" style="display: none;">只能输入大写字母</pre>
      <pre data-bv-validator="stringLength" data-bv-validator-for="Initial" class="help-block" style="display: none;">This value is not valid</pre>
      </div>
      </div>
      </div>
      ...
      ## <th rowspan="1" colspan="1" style="width: 343px;">索引名</th>
      <label class="col-sm-4 control-label">索引名</label>
      <input type="text" id="idxname" name="idxname" maxlength="36" data-bv-notempty="true" data-bv-notempty-message="请输入" class="form-control" data-bv-field="idxname">
      ## <td bgcolor="#FFFFFF" EditType="TextBox" id="idxname">testindex</td>
      ## <th rowspan="1" colspan="1" style="width: 343px;">分片数</th>   
      <label class="col-sm-4 control-label">分片数</label>
      <input type="text" id="shardsnum" name="shardsnum" maxlength="36" data-bv-notempty="true" data-bv-notempty-message="请输入" class="form-control" data-bv-field="shardsnum">
...
<table class="table datatables" align="center" width="900" border="0" cellpadding="0" cellspacing="0" id="tabProduct">    
    <tr> 
      ...
      <th rowspan="1" colspan="1" style="width: 294px;" id="datatype0" Name="DataType" EditType="DropDownList" DataItems="{text:'text:模糊匹配，全文搜索',value:'text'},{text:'keyword:全词匹配，可排序，可聚合',value:'keyword'},{text:'以上两项',value:'two'},{text:'Integer',value:'integer'},{text:'Long',value:'long'},{text:'Short',value:'short'},{text:'Double',value:'double'},{text:'Float',value:'float'},{text:'Boolean',value:'boolean'},{text:'Date',value:'date'}">数据类型</th>
      <th rowspan="1" colspan="1" style="width: 343px;" id="format0" Name="Format">格式</th>
    </tr>  
        <tr onclick="SetRowCanEdit(this)">    
      ...
      <td bgcolor="#FFFFFF" class="datatype" Name="DataType" Value="text" id="datatype1" EditType="DropDownList">text:模糊匹配，全文搜索</td>      
    ...
    <tr onclick="SetRowCanEdit(this)">    
      ...
      <td bgcolor="#FFFFFF" class="datatype" Name="DataType" id="datatype2" Value="date" EditType="DropDownList">Date</td>       
...
<br />    
<input align="center" type="button" class="btn" name="Submit" value="新增字段" onclick="AddRow(document.getElementById('tabProduct'),document.getElementById('hiddenTable'),1)" />    
<input align="center" type="button" class="btn" name="Submit2" value="删除字段" onclick="DeleteRow(document.getElementById('tabProduct'),1)" />    
<input align="center" type="button" class="btn" name="Submit3" value="索引JSON" onclick="IndexJSON(document.getElementById('tabProduct'))" />    
</form> 
</div>
<br></br>
<div style="text-align:center">
<textarea id="textarea1" class="editor span12 single-snippet-editor ace-container-resizable" style="height: 200px;width: 700px;resize: none;">
##用来显示ES的建表语句
</textarea>
</div>

<div style="text-align:center">
<input align="center" type="button" class="btn" name="Create" value="创建" onclick="uploadJson()" />
<br>
...
##             homeAnchor : function(){
##               var url="/Index/editAlias";
##               location.href="/Index/editAlias";
##             }
##         };
...
## var code0 = document.getElementById("code1");

for(var i=1; i<table.rows.length;i++){
  ##  alert(JSON.stringify(GetRowData(tabProduct.rows[i])));
...
## code0.innerText = JSON.stringify(indexJson);
## codeindexjson=json.dumps(indexJson);
## textarea0.innerText=JSON.stringify(JSON.parse(indexJson),null,"\t");
...
## alert(indexJson00);
    $.post("/Index/views/getJson/", {
        ...
        ## var newurl="http://"+location.host+"/ES/?type=elasticsearch&rnd="+s;
