    ...
    <div class="container-fluid">
      ...
      <div class="nav-collapse">
        <ul class="nav editor-nav">
          <li class="app-header">
            <!-- ko if: editorMode -->
              ## <a href='/Template' style="cursor: pointer">
              ...
              <!-- ko if: editorType() == 'template' -->
                Create Template  
              <!-- /ko -->
              % if not request.session.get("authproysso"):          
              <!-- ko if: ['druid','template', 'elasticsearch', 'impala', 'pig', 'hive', 'beeswax', 'rdbms', 'java', 'spark2', 'sqoop1', 'distcp', 'shell', 'mapreduce'].indexOf(editorType()) == -1 -->
                SQL
              <!-- /ko -->
              %endif
...
<br></br>
## font-weight:bold;
<h2 align="center" class="card-heading simple"> 创建模板 </h2> 
  <div data-bind="visibleOnHover: { override: inFocus() || settingsVisible() || dbSelectionVisible() || $root.editorMode() || saveResultsModalVisible(), selector: '.hover-actions' }">
    ...
    <br></br>
  <h3 align="center">模板基本设置</h3>    
<table class="table datatables" align="center" width="900" border="0" cellpadding="0" cellspacing="0" id="tabProduct0">    
    <tr> 
      ## <th rowspan="1" colspan="1" style="width: 150px;"><input style="visibility:hidden;" class="select-all hueCheckbox fa" data-bind="click: selectAll, css: {hueCheckbox: true, 'fa': true, 'fa-check': allSelected}" type="checkbox" name="checkbox" value="checkbox" /></th> 
      <th rowspan="1" colspan="1" style="width: 198px;" Name="DataType" EditType="DropDownList" DataItems="{text:'estest',value:'estest'},{text:'eslog2',value:'eslog2'},{text:'eslog',value:'eslog'},{text:'esbiz',value:'esbiz'}">集群名</th>
      <th rowspan="1" colspan="1" style="width: 198px;" Name="DataType" EditType="DropDownList" DataItems="{text:'不分区',value:'0'},{text:'周',value:'1'},{text:'月',value:'2'},{text:'季',value:'3'},{text:'年',value:'4'},{text:'天',value:'5'}">分区策略</th>
      <th rowspan="1" colspan="1" style="width: 343px;">模板名</th>
      <th rowspan="1" colspan="1" style="width: 343px;">分片数</th>
      ## <td width="32" align="center" bgcolor="#EFEFEF" Name="Checked"><input style="display:none" class="select-all hueCheckbox fa" data-bind="click: selectAll, css: {hueCheckbox: true, 'fa': true, 'fa-check': allSelected}" type="checkbox" name="checkbox" value="checkbox" /></td>    
      ## <td width="186" bgcolor="#EFEFEF" Name="FieldName" EditType="TextBox">字段名</td>    
      ## <td width="186" bgcolor="#EFEFEF" Name="DataType" EditType="DropDownList" DataItems="{text:'text:模糊匹配，全文搜索',value:'text'},{text:'keyword:全词匹配，可排序，可聚合',value:'keyword'},{text:'以上两项',value:'two'},{text:'Integer',value:'integer'},{text:'Long',value:'long'},{text:'Short',value:'short'},{text:'Double',value:'double'},{text:'Float',value:'float'},{text:'Boolean',value:'boolean'},{text:'Date',value:'date'},{text:'Range',value:'range'}">数据类型</td>    
      ## <td width="155" bgcolor="#EFEFEF" Name="Format" EditType="TextBox">格式</td>    
    </tr>    
    <tr onclick="SetRowCanEdit(this)">    
      ## <td align="center" bgcolor="#FFFFFF"><input type="checkbox" name="checkbox2" value="checkbox" /></td>
      <td bgcolor="#FFFFFF" EditType="DropDownList" id="cluster" DataItems="{text:'estest',value:'estest'},{text:'eslog2',value:'eslog2'},{text:'eslog',value:'eslog'},{text:'esbiz',value:'esbiz'}">eslog</td>
      <td bgcolor="#FFFFFF" EditType="DropDownList" id="partitionGranularity" DataItems="{text:'NoPartition',value:'0'},{text:'week',value:'1'},{text:'month',value:'2'},{text:'quarter',value:'3'},{text:'year',value:'4'},{text:'day',value:'5'}">month</td>

      <td bgcolor="#FFFFFF" EditType="TextBox" id="idxname">testtemplate</td>
      ## <input EditType="TextBox" id="idxname" class="inputIdxName" validate="nonempty" placeholder="Index Name.">
      ## </td>        
      <td  bgcolor="#FFFFFF" EditType="TextBox" id="shardsnum">5</td>
##       <input EditType="TextBox" id="shardsnum" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"
##  class="inputShardsNum" validate="nonempty" placeholder="Number of Shards.">
      ## </td>       
    </tr>  
    <tr> 
      ## <th rowspan="1" colspan="1" style="width: 150px;"><input style="visibility:hidden;" class="select-all hueCheckbox fa" data-bind="click: selectAll, css: {hueCheckbox: true, 'fa': true, 'fa-check': allSelected}" type="checkbox" name="checkbox" value="checkbox" /></th> 
      ## <th rowspan="1" colspan="1" style="width: 294px;" Name="DataType" EditType="DropDownList" DataItems="{text:'estest',value:'estest'},{text:'eslog2',value:'eslog2'},{text:'eslog',value:'eslog'},{text:'esbiz',value:'esbiz'}">集群名</th>
      <th rowspan="1" colspan="1" style="width: 343px;">副本数</th>
      <th rowspan="1" colspan="1" style="width: 343px;">最大返回条数</th>
      <th rowspan="1" colspan="1" style="width: 343px;">别名</th>
      <th rowspan="1" colspan="1" style="width: 343px;"></th>
      ## <td width="32" align="center" bgcolor="#EFEFEF" Name="Checked"><input style="display:none" class="select-all hueCheckbox fa" data-bind="click: selectAll, css: {hueCheckbox: true, 'fa': true, 'fa-check': allSelected}" type="checkbox" name="checkbox" value="checkbox" /></td>    
      ## <td width="186" bgcolor="#EFEFEF" Name="FieldName" EditType="TextBox">字段名</td>    
      ## <td width="186" bgcolor="#EFEFEF" Name="DataType" EditType="DropDownList" DataItems="{text:'text:模糊匹配，全文搜索',value:'text'},{text:'keyword:全词匹配，可排序，可聚合',value:'keyword'},{text:'以上两项',value:'two'},{text:'Integer',value:'integer'},{text:'Long',value:'long'},{text:'Short',value:'short'},{text:'Double',value:'double'},{text:'Float',value:'float'},{text:'Boolean',value:'boolean'},{text:'Date',value:'date'},{text:'Range',value:'range'}">数据类型</td>    
      ## <td width="155" bgcolor="#EFEFEF" Name="Format" EditType="TextBox">格式</td>    
    ...
    <tr onclick="SetRowCanEdit(this)">    
      ...
      <td bgcolor="#FFFFFF" EditType="TextBox" id="replicasnum">1</td>
           ## <input EditType="TextBox" id="replicasnum" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" validate="nonempty" placeholder="Number of Replicas.">
      ## </td>    
      <td bgcolor="#FFFFFF" EditType="TextBox" id="maxresultwindow">10000</td>
      ## <input EditType="TextBox" id="maxresultwindow" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" validate="nonempty" placeholder="Number of Results.">
      ## </td>     
      <td bgcolor="#FFFFFF" EditType="TextBox" id="Alias1">alias1,alias2</td>
      <td bgcolor="#FFFFFF" EditType="TextBox" id="nullvalue"></td>
      ## <input EditType="TextBox" id="Alias1" class="inputalias" validate="nonempty" placeholder="alias1,alias2">
      ## </td>    
    </tr>    
</table>   
...
<h3 align="center">编辑模板字段</h3>    
<table class="table datatables" align="center" width="900" border="0" cellpadding="0" cellspacing="0" id="tabProduct">    
    <tr>    
      <th rowspan="1" colspan="1" style="width: 150px;"><input style="visibility:hidden;" class="select-all hueCheckbox fa" data-bind="click: selectAll, css: {hueCheckbox: true, 'fa': true, 'fa-check': allSelected}" type="checkbox" name="checkbox" value="checkbox" /></th>    
      <th rowspan="1" colspan="1" style="width: 343px;" Name="FieldName">字段名</th>
      <th rowspan="1" colspan="1" style="width: 294px;" onchange="checkType(this.id,this.Value)" Name="DataType" EditType="DropDownList" DataItems="{text:'text:模糊匹配，全文搜索',value:'text'},{text:'keyword:全词匹配，可排序，可聚合',value:'keyword'},{text:'以上两项',value:'two'},{text:'Integer',value:'integer'},{text:'Long',value:'long'},{text:'Short',value:'short'},{text:'Double',value:'double'},{text:'Float',value:'float'},{text:'Boolean',value:'boolean'},{text:'Date',value:'date'}">数据类型</th>
      <th rowspan="1" colspan="1" style="width: 343px;" Name="Format">格式</th>
   </tr>    
    <tr onclick="SetRowCanEdit(this)">    
      <td align="center" bgcolor="#FFFFFF"><input type="checkbox" name="checkbox2" value="checkbox" /></td>    
      <td bgcolor="#FFFFFF" Name="FieldName" EditType="TextBox">field1</td>    
      <td bgcolor="#FFFFFF" Name="DataType" class="datatype" id="datatype1" Value="text" EditType="DropDownList">text:模糊匹配，全文搜索</td>      
      <td bgcolor="#FFFFFF" Name="Format" id="format1" EditType="TextBox"></td>     
    </tr>    
    <tr onclick="SetRowCanEdit(this)">    
      <td align="center" bgcolor="#FFFFFF"><input type="checkbox" name="checkbox22" value="checkbox" /></td>    
      <td bgcolor="#FFFFFF" Name="FieldName" EditType="TextBox">field2</td>    
      <td bgcolor="#FFFFFF" Name="DataType" class="datatype" id="datatype2" Value="date" EditType="DropDownList">Date</td>       
      <td bgcolor="#FFFFFF" Name="Format" id="format2" EditType="TextBox">yyyyMMddHHmmssSSSZ</td>       
    ## </tr>    
</table>    
...
<table id="hiddenTable" style="display:none">  
    <tr onclick="SetRowCanEdit(this)">    
      <td align="center" bgcolor="#FFFFFF"><input type="checkbox" name="checkbox22" value="checkbox" /></td>    
      <td bgcolor="#FFFFFF" Name="FieldName" EditType="TextBox">field2</td>    
      <td bgcolor="#FFFFFF" class="datatype" Name="DataType" id="datatypehidden" Value="date" EditType="DropDownList">Date</td>       
      <td bgcolor="#FFFFFF" Name="Format" id="formathidden" EditType="TextBox">yyyyMMddHHmmssSSSZ</td>       
   
    </tr>    
</table>

<br />    
<input align="center" type="button" class="btn" name="Submit" value="新增" onclick="AddRow(document.getElementById('tabProduct'),document.getElementById('hiddenTable'),1)" />    
<input align="center" type="button" class="btn" name="Submit2" value="删除" onclick="DeleteRow(document.getElementById('tabProduct'),1)" />     
<input align="center" type="button" class="btn" name="Submit3" value="模板JSON" onclick="TemplateJSON(document.getElementById('tabProduct'))" />    
</form> 
</div>
<br></br>
<div style="text-align:center">
<textarea id="textarea1" style="height: 200px;width: 700px;resize: none;">
##用来显示ES的建表语句
</textarea>
</div>

<div style="text-align:center">
<input align="center" type="button" class="btn" name="Create" value="创建" onclick="uploadTemplateJson()" />
## <h3 align="center" style="font-style:italic;"> (单击进入模板管理） </h3>
## <span class="widget-label" onclick="openTemplateManager()">(单击进入模板管理）</span>
</div>
<br></br>
</div>
</script>
...
var flag=0;
var i=3;
var teldUserName=$.get("/TeldUserInfo", function(result){console.log(result)});
##用来判断是删除 还是增加按钮 以便count值进行计算 
window.onload=function(){
  
  teldUserName=$.get("/TeldUserInfo", function(result){console.log(result)});

}

function checkType(id,invalue){
  var num=id.substr(8);
  ...
  var formatid="format"+num;
  if(value=="Date"){   
    document.getElementById(formatid).innerText="yyyyMMddHHmmssSSSZ";
  }else{
    document.getElementById(formatid).innerText='';
  }
...
function DecInput() {  
  ...
  var td1=document.getElementById("td1Alias"+count2);
  var td2=document.getElementById("td2Alias"+count2);
  var tr=document.getElementById("trAlias"+count2);
  var table=document.getElementById("tableAlias"+count2);
  
  var whichInput = document.getElementById("Alias" + count2);  
  var whichSpan = document.getElementById("spanAlias" + count2);  
  if(count2>1){
  td2.removeChild(whichInput);  
  td1.removeChild(whichSpan);
  tr.removeChild(td1);
  tr.removeChild(td2);
  table.removeChild(tr);
  question.removeChild(table);
...
function AddAliasInput(table, index){    
  ...
  table1.id="tableAlias"+count;
  table1.width="100%";
  table1.border="0";
  table1.align="right";
  question.appendChild(table1);
  

  var tr1=document.createElement("tr");
  tr1.id="trAlias"+count;
  ## question.appendChild(tr1);
  table1.appendChild(tr1);

  var td1=document.createElement("td");
  td1.id="td1Alias"+count;
  td1.width="42%";
  td1.align="right";
  tr1.appendChild(td1);
  ...
  span.innerText = "别名"+count+"\:"; 
	span.class="widget-label";
  ## question.appendChild(span);
  td1.appendChild(span);

  var td2=document.createElement("td");
  td2.id="td2Alias"+count;
  td2.width="58%";
  td2.align="left";
  ## question.appendChild(td2);
  tr1.appendChild(td2);
...
if(element.className=="datatype"){
  var value=document.getElementById(element.id).innerText;
  element.addEventListener("onchange",checkType(element.id,value));
}   
}    
...
##添加行    
function AddRow(table, table2, index){    
var rowNumber= table.rows.length-1;

if (rowNumber==0){
  var lastRow = table2.rows[rowNumber];
}else{
...
newRow.cells[1].innerText='fieldname';
## newRow.cells[1].value='';
i=i+1;

newRow.cells[2].id="datatype"+i;
newRow.cells[2].class="datatype";

newRow.cells[3].id="format"+i;
...
inputIdxName=document.getElementById("idxname").value;
incluster=inputCluster;
var inputShardsNum=document.getElementById("shardsnum").value;

var inputReplicasNum=document.getElementById("replicasnum").value;

var inputAlias={};
if (aliasNum==1){
  var aliasName=document.getElementById("Alias1").value.toString();
  ## if(typeof aliasName != "undefined" || aliasName != null || aliasName != ""){
    if(aliasName.length!=0){
    ## var aliases={aliasName:{}}
    inputAlias[aliasName]={};
  }
}else{
  for(var num=1;num<=aliasNum;num++){
    var aliasName=document.getElementById("Alias"+num.toString()).value;
    inputAlias[aliasName]={};
  }
...
var indexName={"properties":properties}
var mappings={};
mappings[inputIdxName]=indexName;
...
settings["index"]["number_of_shards"]=inputShardsNum;
settings["index"]["number_of_replicas"]=inputReplicasNum;

indexJson["settings"]=settings;
indexJson["mappings"]=mappings;
indexJson["aliases"]=inputAlias;
## alert("Json:"+JSON.stringify(indexJson));
textarea0.innerHTML=JSON.stringify(indexJson);

## textarea0.innerHTML=JSON.stringify(tableData);
## return tableData;       
}


function TemplateJSON(table){ 
teldUserName=$.get("/TeldUserInfo", function(result){console.log(result)});  
flag=2;
indexJson={}
var inputCluster=document.getElementById("cluster").innerText;

var maxresultwindow=document.getElementById("maxresultwindow").innerText;

if(maxresultwindow>2147483647){
  alert("Max Result Window ERROR!");
  return;
}
inputIdxName=document.getElementById("idxname").innerText;
incluster=inputCluster;
var inputShardsNum=document.getElementById("shardsnum").innerText;
var inputReplicasNum=document.getElementById("replicasnum").innerText;
if(inputShardsNum>20){
  alert("Number of Shards should be less than 20");
  return;
}
if(inputReplicasNum>2){
  alert("Number of Replicas should be less than 3");
  return;
}
var inputAlias={};

var aliasName=document.getElementById("Alias1").innerText.toString();

if(typeof aliasName != "undefined" && aliasName != null && aliasName != ""&&aliasName!=" "){
  var strs= new Array(); //定义一数组 
  strs=aliasName.split(",");
  for(var num=1;num<=strs.length;num++){
    inputAlias[strs[num-1]]={};
  }
}
...
var indexName={"properties":properties}
var mappings={};
mappings["_default_"]=indexName;

var settings={};
settings["index"]={};
## settings["index"]["number_of_shards"]=inputShardsNum;
## settings["index"]["number_of_replicas"]=inputReplicasNum;
## settings["index"]["max_result_window"]=maxresultwindow;
...
indexJson["template"]=inputIdxName+"*";
indexJson["settings"]=settings;
indexJson["mappings"]=mappings;
## indexJson["aliases"]=inputAlias;
if(JSON.stringify(inputAlias) != "{}"){
  indexJson["aliases"]=inputAlias;
}
## alert("Json:"+JSON.stringify(indexJson));
textarea0.value="";
textarea0.value=JSON.stringify(indexJson);
textarea0.innerText=JSON.stringify(indexJson);
textarea0.innerHTML=JSON.stringify(indexJson);
...
function uploadTemplateJson(){
var partition=document.getElementById("partitionGranularity").innerText;
var partitionGranularity=2;
if(partition=="NoPartition"){
  partitionGranularity=0;
}else if(partition=="week"){
  partitionGranularity=1;
}else if(partition=="month"){
  partitionGranularity=2;
}else if(partition=="quarter"){
  partitionGranularity=3;
}else if(partition=="year"){
  partitionGranularity=4;
}else if(partition=="day"){
  partitionGranularity=5;
}else{
  alert("Wrong Partition Granularity!");
  return;
}

## debugger;
var url="/Template/views/getJson/";
var indexJson00=document.getElementById("textarea1").value;

jsonindexstring=JSON.parse(indexJson00);

var getinputReplicasNum=jsonindexstring['settings']['index']['number_of_replicas'];

var getinputShardsNum=jsonindexstring['settings']['index']['number_of_shards'];

var getinputResultWindow=jsonindexstring['settings']['index']['max_result_window'];

if(getinputShardsNum>20){
  alert("Number of Shards should be less than 20");
  return;
}
if(getinputReplicasNum>2){
  alert("Number of Replicas should be less than 3");
  return;
}
if(getinputResultWindow>2147483647){
  alert("Max Result Window ERROR!");
  return;
}


if(teldUserName["responseJSON"]==undefined){
  strusername="";
  strusergroup="";
  struserid="";
}else{

if((struserid=teldUserName["responseJSON"]["UserId"])==undefined){
  struserid="";
}else{
  struserid=teldUserName["responseJSON"]["UserId"];
}

if((strusername=teldUserName["responseJSON"]["UserName"])==undefined){
  strusername="";
}else{
  strusername=teldUserName["responseJSON"]["UserName"];
}

if((strusergroup=teldUserName["responseJSON"]["WorkGroupName"])==undefined){
  strusergroup="";
}else{
  strusergroup=teldUserName["responseJSON"]["WorkGroupName"];
}
}

    $.post("/Template/views/getJson/", {
        indexJson: indexJson00,
        indexName:ko.mapping.toJSON(inputIdxName),
        inputCluster:ko.mapping.toJSON(incluster),
        flag:ko.mapping.toJSON(flag),
        partitionGranularity:ko.mapping.toJSON(partitionGranularity),
        myWorkGroup:ko.mapping.toJSON(strusergroup),
        myUserName:ko.mapping.toJSON(strusername),
        myUserId:ko.mapping.toJSON(struserid)
      }, function(msg) {
        ## alert(typeof(msg));
        var objmsg=JSON.parse(msg);
        ## alert(typeof(objmsg));
        if(objmsg["acknowledged"]==true){alert("创建成功!");
        ## var s=Math.random()*10;
        ## var newurl="http://"+location.host+"/ES/?type=template&rnd="+s;
        ## location.assign(newurl);
        location.reload(true);
        }
        else if(objmsg["error"]["root_cause"][0]["type"]=="index_already_exists_exception"){alert("重复创建 创建失败!");}
        else{alert("创建失败!");}
      });
