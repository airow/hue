...
<table class="table datatables" align="center" width="900" border="0" cellpadding="0" cellspacing="0" id="tabProduct0">    
    ...
    <tr onclick="SetRowCanEdit(this)">    
      <td bgcolor="#FFFFFF" EditType="DropDownList" id="cluster" DataItems="{text:'estest',value:'estest'},{text:'eslog2',value:'eslog2'},{text:'eslog',value:'eslog'},{text:'esbiz',value:'esbiz'}"></td>
...
<script type="text/javascript">
  ...
  }else if(clustername=="esbiz"){
    document.getElementById("cluster").innerText = "esbiz"             
  }else if(clustername=="eslog2"){
    document.getElementById("cluster").innerText = "eslog2"
  }else{
    document.getElementById("cluster").innerText = "estest"
  }
...
if((strusergroup=teldUserName["responseJSON"]["WorkGroupName"])==undefined){
  ...
  strusergroup=teldUserName["responseJSON"]["WorkGroupName"];
    ...
    $.post("/Template/views/getJson/", {
        ...
        completeindexName:ko.mapping.toJSON("${indName}"),
