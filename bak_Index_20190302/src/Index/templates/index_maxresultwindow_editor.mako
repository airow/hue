...
<%namespace name="assist" file="/index_assist.mako" />
<%namespace name="configKoComponents" file="/config_ko_components.mako" />
<%namespace name="editorComponents" file="index_maxresultwindow_editor_components.mako" />
...
${ editorComponents.commonHTML(indName=indName,indexmaxresultwindow=nummaxresultwindow,is_embeddable=is_embeddable, suffix='editor') }
