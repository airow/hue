...
<script type="text/html" id="snippet${ suffix }">
  <div data-bind="visibleOnHover: { override: inFocus() || settingsVisible() || dbSelectionVisible() || $root.editorMode() || saveResultsModalVisible(), selector: '.hover-actions' }">
    ...
    <div class="airy" style="text-align: center">
          ...
          ## <select id="cluster" style="display:none"><option value="http://192.168.3.252:12200/">ESLog2</option><option value="http://192.168.2.244:12200/">ESLog</option><option value="http://192.168.2.237:12200/">ESBiz</option></select>
          <select id="cluster" style="display:none"><option value="http://hdpjntest.chinacloudapp.cn:12200/">ESLog2</option><option value="http://hdpjntest.chinacloudapp.cn:12200/">ESLog</option><option value="http://hdpjntest.chinacloudapp.cn:12200/">ESBiz</option></select>
        </div>
##         <script>
## alert(indexAlias)
## </script>
