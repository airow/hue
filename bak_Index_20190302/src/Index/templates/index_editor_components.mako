...
<table class="table datatables" align="center" width="900" border="0" cellpadding="0" cellspacing="0" id="tabProduct0">    
    <tr>
      <th rowspan="1" colspan="1" style="width: 294px;" Name="DataType" EditType="DropDownList" DataItems="{text:'ESLog2',value:'ESLog2'},{text:'ESLog',value:'ESLog'},{text:'ESBiz',value:'ESBiz'}">集群名</th>
    ...
    <tr onclick="SetRowCanEdit(this)">    
      <td bgcolor="#FFFFFF" EditType="DropDownList" id="cluster" DataItems="{text:'ESLog2',value:'ESLog2'},{text:'ESLog',value:'ESLog'},{text:'ESBiz',value:'ESBiz'}">ESLog</td>
