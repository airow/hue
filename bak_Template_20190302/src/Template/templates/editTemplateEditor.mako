...
<%namespace name="assist" file="/tempassist.mako" />
<%namespace name="configKoComponents" file="/config_ko_components.mako" />
<%namespace name="editorComponents" file="editTemplateEditorComponents.mako" />
...
${ editorComponents.commonHTML(templatefieldFormat=templatefieldFormat,templatefieldType=templatefieldType,templateFields=templateFields,indexAlias=indAliases,tempMaxResultWindow=tempMaxResultWindow,tempNumofShards=tempNumofShards,tempNumofRep=tempNumofRep,indName=indName,orgcluster=cluster,is_embeddable=is_embeddable, suffix='editor') }
