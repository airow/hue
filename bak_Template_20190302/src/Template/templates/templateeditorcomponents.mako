...
<table class="table datatables" align="center" width="900" border="0" cellpadding="0" cellspacing="0" id="tabProduct0">    
    <tr> 
      ...
      <th rowspan="1" colspan="1" style="width: 198px;" Name="DataType" EditType="DropDownList" DataItems="{text:'eslog',value:'eslog'},{text:'esbiz',value:'esbiz'}">集群名</th>
    ...
    <tr onclick="SetRowCanEdit(this)">    
      ...
      <td bgcolor="#FFFFFF" EditType="DropDownList" id="cluster" DataItems="{text:'eslog',value:'eslog'},{text:'esbiz',value:'esbiz'}">eslog</td>
...
##  class="inputShardsNum" validate="nonempty" placeholder="Number of Shards.">
    ...
    <tr> 
      ## <th rowspan="1" colspan="1" style="width: 150px;"><input style="visibility:hidden;" class="select-all hueCheckbox fa" data-bind="click: selectAll, css: {hueCheckbox: true, 'fa': true, 'fa-check': allSelected}" type="checkbox" name="checkbox" value="checkbox" /></th> 
      ## <th rowspan="1" colspan="1" style="width: 294px;" Name="DataType" EditType="DropDownList" DataItems="{text:'ESLog',value:'ESLog'},{text:'ESBiz',value:'ESBiz'}">集群名</th>
